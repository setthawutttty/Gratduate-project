      ...
      <Card>
        ...
        <CardBody className='py-2 my-25'>
          <div className='d-flex'>
            <div className='me-25'>
              <img className='rounded me-50' src={"https://api.fleamarket-rmutl.com/img/store/profile/4.png"} alt='Generic placeholder image' height='100' width='100' />
            </div>
          ...
          <Form className='mt-2 pt-50' onSubmit={() => console.log()}>
            <Row>
